  ...
  return (
    <div class="h-screen w-full flex items-center justify-center bg-gray-900 p-4">
      <div class="glass-dark w-full max-w-sm rounded-2xl p-8 border border-white/10 text-center">
        ...
        <h2 class="text-xl font-bold mb-1">Sesión privada</h2>
        <p class="text-sm text-gray-400 mb-1">
          Esta instancia está protegida con contraseña. Ingresa para acceder a tu biblioteca.
        </p>
        <p class="text-xs text-gray-500 mb-6">
          Servidor: <span class="text-purple-300/80">{typeof window !== 'undefined' ? window.location.host : ''}</span>
        </p>
        <input
          type="password"
          value={password}
